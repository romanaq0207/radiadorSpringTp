...
function AutoAccidentRegister() {
    ...
    const [nuevoAccidente, setNuevoAccidente] = useState({ fecha: '', hora: '', ubicacion: '', nombre_usuario: '', stock_utilizado: '' });
    ...
    const handleAddAccidente = () => {
        ...
        setNuevoAccidente({ fecha: '', hora: '', ubicacion: '', nombre_usuario: '', stock_utilizado: '' });
    };
    ...
    return (
        <div className="auto-detail">
            ...
            <input
                ...
                value={nuevoAccidente.nombre_usuario}
                onChange={handleInputChange}
            />
            <input
                type="text"
                name="stock_utilizado"
                placeholder="Stock Utilizado"
                value={nuevoAccidente.stock_utilizado}
                onChange={handleInputChange}
            />
            <button onClick={handleAddAccidente}>Registrar Accidente</button>
